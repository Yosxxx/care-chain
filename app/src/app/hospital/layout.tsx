...
// <main>
//   <Navbar />
//   <div className="grid grid-cols-14 min-w-[1400px] max-w-[1400px] mx-auto gap-x-5">
//     <div className="sticky top-[4rem] h-[calc(100vh_-_4rem)] max-h-screen  col-span-2">
//       <AppSidebar dynamicItems={SIDEBAR_ITEMS} isAdmin={isAdmin} />
//     </div>

//     <div className=" col-span-8">{children}</div>
//     <div className="sticky top-[4rem] h-fit col-span-2"></div>
//   </div>
// </main>
